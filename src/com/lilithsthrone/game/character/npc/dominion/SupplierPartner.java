...
public class SupplierPartner extends NPC {
	...
	public void setStartingBody(boolean setPersona) {
		...
		// Coverings:
		this.setEyeCovering(new Covering(BodyCoveringType.EYE_DOG_MORPH, Color.EYE_BROWN));

		this.setHairCovering(new Covering(BodyCoveringType.HAIR_CANINE_FUR, Color.COVERING_BLACK), true);
		...
		this.setHairCovering(new Covering(BodyCoveringType.BODY_HAIR_CANINE_FUR, Color.COVERING_BLACK), false);
...
//		this.setEyeShadow(new Covering(BodyCoveringType.MAKEUP_EYE_SHADOW, Color.COVERING_PURPLE));
	...
	public void equipClothing(boolean replaceUnsuitableClothing, boolean addWeapons, boolean addScarsAndTattoos, boolean addAccessories) {
		...
		this.equipClothingFromNowhere(AbstractClothingType.generateClothing(ClothingType.TORSO_SHORT_SLEEVE_SHIRT, Color.CLOTHING_BLACK, false), true, this);
