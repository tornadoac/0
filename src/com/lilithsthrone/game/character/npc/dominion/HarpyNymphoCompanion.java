...
public class HarpyNymphoCompanion extends NPC {
	...
	public void setStartingBody(boolean setPersona) {
		...
		this.setSkinCovering(new Covering(BodyCoveringType.HUMAN, Color.SKIN_DARK), true);

		this.setHairCovering(new Covering(BodyCoveringType.HAIR_HARPY, Color.COVERING_BLUE), true);
		...
		this.setHairCovering(new Covering(BodyCoveringType.BODY_HAIR_HARPY, Color.COVERING_BLUE_LIGHT), false);
...
//		this.setBlusher(new Covering(BodyCoveringType.MAKEUP_BLUSHER, Color.COVERING_RED));
	...
	public void equipClothing(boolean replaceUnsuitableClothing, boolean addWeapons, boolean addScarsAndTattoos, boolean addAccessories) {
		...
		this.equipClothingFromNowhere(AbstractClothingType.generateClothing(ClothingType.GROIN_BOYSHORTS, Color.CLOTHING_BLUE_LIGHT, false), true, this);
		this.equipClothingFromNowhere(AbstractClothingType.generateClothing(ClothingType.CHEST_FULLCUP_BRA, Color.CLOTHING_BLUE_LIGHT, false), true, this);
		this.equipClothingFromNowhere(AbstractClothingType.generateClothing(ClothingType.TORSO_SHORT_CROPTOP, Color.CLOTHING_PURPLE_LIGHT, false), true, this);
		this.equipClothingFromNowhere(AbstractClothingType.generateClothing(ClothingType.LEG_SKIRT, Color.CLOTHING_WHITE, false), true, this);
