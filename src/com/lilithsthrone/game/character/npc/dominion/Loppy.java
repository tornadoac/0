...
public class Loppy extends NPC {
	...
	public void setStartingBody(boolean setPersona) {
		...
		// Coverings:
		this.setEyeCovering(new Covering(BodyCoveringType.EYE_HUMAN, Color.EYE_BROWN));
		this.setEyeCovering(new Covering(BodyCoveringType.EYE_RABBIT, Color.EYE_BROWN));
		this.setSkinCovering(new Covering(BodyCoveringType.HUMAN, Color.SKIN_LIGHT), true);
		this.setSkinCovering(new Covering(BodyCoveringType.RABBIT_FUR, Color.COVERING_BROWN_DARK), true);

		this.setHairCovering(new Covering(BodyCoveringType.HAIR_HUMAN, Color.COVERING_BROWN_DARK), true);
		this.setHairCovering(new Covering(BodyCoveringType.HAIR_RABBIT_FUR, Color.COVERING_BROWN_DARK), true);
		this.setHairLength(HairLength.FOUR_MID_BACK.getMedianValue());
		this.setHairStyle(HairStyle.WAVY);

		this.setHairCovering(new Covering(BodyCoveringType.BODY_HAIR_HUMAN, Color.COVERING_BLACK), false);
		this.setHairCovering(new Covering(BodyCoveringType.BODY_HAIR_RABBIT_FUR, Color.COVERING_BLACK), false);
...
//		this.setBlusher(new Covering(BodyCoveringType.MAKEUP_BLUSHER, Color.COVERING_RED));
		this.setLipstick(new Covering(BodyCoveringType.MAKEUP_LIPSTICK, Color.COVERING_PURPLE));
	...
	public void equipClothing(boolean replaceUnsuitableClothing, boolean addWeapons, boolean addScarsAndTattoos, boolean addAccessories) {
		...
		this.equipClothingFromNowhere(AbstractClothingType.generateClothing(ClothingType.STOMACH_LOWBACK_BODY, Color.CLOTHING_PURPLE, false), true, this);
		...
		this.equipClothingFromNowhere(AbstractClothingType.generateClothing(ClothingType.FOOT_STILETTO_HEELS, Color.CLOTHING_PURPLE, false), true, this);
		this.equipClothingFromNowhere(AbstractClothingType.generateClothing(ClothingType.NECK_COLLAR_BOWTIE, Color.CLOTHING_PURPLE, false), true, this);
