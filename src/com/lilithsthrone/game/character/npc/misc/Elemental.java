...
public class Elemental extends NPC {
	...
	public Elemental(Gender gender, GameCharacter summoner, boolean isImported) {
		super(isImported, null, "", summoner==null?Main.getProperties().ageLimitLower:summoner.getAge(), summoner==null?Month.JANUARY:summoner.getBirthMonth(), summoner==null?1:summoner.getDayOfBirth(), 20, gender, Subspecies.DEMON, RaceStage.GREATER,
