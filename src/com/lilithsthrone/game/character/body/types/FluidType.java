...
public enum FluidType implements BodyPartTypeInterface {
	...
	private FluidFlavor flavor;
	private List<String> descriptors;
	private List<FluidModifier> fluidModifiers;
	private Race race;

	private FluidType(FluidTypeBase baseType, BodyCoveringType bodyCoveringType, FluidFlavor flavor, List<String> descriptors, List<FluidModifier> fluidModifiers, Race race) {
