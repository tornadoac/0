...
public enum TesticleSize {
	...
	ZERO_VESTIGIAL("vestigial", 0, Color.GENERIC_SIZE_ONE),
	...
	THREE_LARGE("large", 3, Color.GENERIC_SIZE_FOUR),

	/**Unrealistically large for a human. Average for a horse-morph.*/
	FOUR_HUGE("huge", 4, Color.GENERIC_SIZE_FIVE),

	/**Large for a horse-morph.*/
	FIVE_MASSIVE("massive", 5, Color.GENERIC_SIZE_SIX),

	/**Getting pretty absurd.*/
	SIX_GIGANTIC("gigantic", 6, Color.GENERIC_SIZE_SEVEN),

	/**"Extreme proportion" content.*/
	SEVEN_ABSURD("absurdly enormous", 7, Color.GENERIC_SIZE_EIGHT);

	private int value;
	private String descriptor;
	private Color color;

	private TesticleSize(String descriptor, int value, Color color) {
