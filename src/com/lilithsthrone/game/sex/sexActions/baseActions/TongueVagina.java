...
public class TongueVagina {
	...
	public static final SexAction CUNNILINGUS_STOP = new SexAction(
		...
		switch(Sex.getSexPace(Sex.getCharacterTargetedForSexAction(this))) {
			case SUB_RESISTING:
				UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
						" [npc2.Name] [npc2.verb(continue)] to struggle against [npc.name], [npc2.sobbing] and squirming in discomfort as [npc2.she] realize that [npc.name] isn't completely finished with [npc2.herHim] just yet.",

						" Realizing that [npc.she] hasn't completely finished with [npc2.herHim] just yet, [npc2.name] [npc2.verb(continue)] struggling and [npc2.sobbing],"
	...
	public static final SexAction RECEIVING_CUNNILINGUS_STOP = new SexAction(
		...
		public String getDescription() {
			...
			switch(Sex.getSexPace(Sex.getCharacterTargetedForSexAction(this))) {
				case SUB_RESISTING:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							" With tears streaming down [npc2.her] [npc2.face], [npc2.name] [npc2.verb(let)] out [npc2.a_sob+] as [npc2.she] realizes that [npc.nameIsFull]n't finished with [npc2.herHim] just yet.",
