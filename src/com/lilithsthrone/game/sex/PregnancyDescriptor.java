			...
			if(characterBeingImpregnated.isPlayer()){
					return UtilText.parse(characterProvidingCum,
							"<p>"
								...
								+", but because <b style='color:" + Color.GENERIC_SEX.toWebHexString() + ";'>you're already pregnant, you don't have to worry about it!</b>"
							+ "</p>");
			}else{
				if(characterProvidingCum.isPlayer()) {
					return UtilText.parse(characterBeingImpregnated,
							"<p>"
								+ "[npc.Name] is already pregnant, <b style='color:" + Color.GENERIC_SEX.toWebHexString() + ";'>so there's no chance that you've knocked [npc.herHim] up!</b>"
							+ "</p>");
				} else {
					return UtilText.parse(characterProvidingCum, characterBeingImpregnated,
							"<p>"
								+ "[npc2.Name] is already pregnant, <b style='color:" + Color.GENERIC_SEX.toWebHexString() + ";'>so there's no chance that [npc1.namePos] knocked [npc2.herHim] up!</b>"
							+ "</p>");
				}
			}
		}
							...
							"<p>"
								+ "Despite feeling [npc.namePos] [npc.cum+] "
									+(isSlime
										?"dispersing through your slimy body, seeking to impregnate your core"
										:"deep in your womb")
								+", you feel that <b style='color:" + Color.GENERIC_SEX.toWebHexString() + ";'>you aren't going to get pregnant from this.</b>"
							+ "</p>");
			}else{
				if(characterProvidingCum.isPlayer()) {
					return UtilText.parse(characterBeingImpregnated,
							"<p>"
								+ "Despite having unprotected sex with [npc.name], <b style='color:" + Color.GENERIC_SEX.toWebHexString() + ";'>[npc.she] isn't going to get pregnant from this.</b>"
							+ "</p>");
				} else {
					return UtilText.parse(characterProvidingCum, characterBeingImpregnated,
							"<p>"
								+ "Despite having unprotected sex with [npc2.name], <b style='color:" + Color.GENERIC_SEX.toWebHexString() + ";'>there's no chance that [npc1.name] has impregnated [npc2.herHim].</b>"
							+ "</p>");
				}
			}
		}
				...
				return UtilText.parse(characterProvidingCum,
						"<p>"
							...
							+(isSlime
									?"dispersing through your slimy body, seeking to impregnate your core"
									:"deep in your womb")
							+", and you realize that <b style='color:" + Color.GENERIC_SEX.toWebHexString() + ";'>"
				...
				if(characterProvidingCum.isPlayer()) {
					return UtilText.parse(characterBeingImpregnated,
							...
							+(isSlime
									?"slimy body"
									:"womb")
							+", you realize that <b style='color:" + Color.GENERIC_SEX.toWebHexString() + ";'>"
									+ (characterBeingImpregnated.hasStatusEffect(StatusEffect.PREGNANT_0)
					...
					return UtilText.parse(characterProvidingCum, characterBeingImpregnated,
							"<p>"
								...
								+(isSlime
										?"slimy body"
										:"womb")
								+", <b style='color:" + Color.GENERIC_SEX.toWebHexString() + ";'>"
										+ (characterBeingImpregnated.hasStatusEffect(StatusEffect.PREGNANT_0)
