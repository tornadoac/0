...
public enum SlaveEventTag {
	...
	WASHED_BODY_ANAL_CREAMPIE("<span style='color:"+Color.BASE_AQUA.toWebHexString()+";'>Cleaned Anal Creampie</span>"),

	WASHED_BODY_VAGINAL_CREAMPIE("<span style='color:"+Color.BASE_AQUA.toWebHexString()+";'>Cleaned Pussy Creampie</span>"),

	WASHED_BODY_NIPPLE_CREAMPIE("<span style='color:"+Color.BASE_AQUA.toWebHexString()+";'>Cleaned Nipple Creampie</span>"),

	WASHED_CLOTHES("<span style='color:"+Color.BASE_AQUA.toWebHexString()+";'>Cleaned Clothes</span>"),
