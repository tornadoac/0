		...
		public String getContent() {
			if(Main.game.getCurrentWeather()==Weather.MAGIC_STORM) {
				return "<p>"
						...
						+ "</p>"
						+ "<p>"
							+ "Traveling further up the road, you notice that there a curious amount of demons walking around in this area, and, what's more, you notice that most of them are carrying shopping bags of some sort or another."
							+ " The cause of this unusual gathering is soon made apparent, as up ahead you see a huge shopping center, with yet more demons loitering around the ornate entranceway."
						+ "</p>"
						+ "<p>"
				...
				return "<p>"
						...
						+ " The cause of this unusual increase in traffic is soon made apparent, as up ahead you see a huge shopping center, with yet more people loitering around the ornate entranceway."
					+ "</p>"
					+ "<p>"
						+ "As you approach, you take a good look at the massive building, noting that its style is very reminiscent of that of a grand Victorian shopping arcade."
