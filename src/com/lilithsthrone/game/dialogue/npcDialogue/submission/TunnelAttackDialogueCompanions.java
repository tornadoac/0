 ...
 * @author Innoxia
 */
public class TunnelAttackDialogueCompanions {
	...
	public static final DialogueNode TUNNEL_ATTACK = new DialogueNode("Assaulted!", "A figure jumps out from the shadows!", true) {
		...
		public String getContent() {
			...
			if(getMugger().getLastTimeEncountered() != -1) {
				if(isWantsToFight()) {
					UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_REPEAT_INTRO", getAllCharacters()));
					
					if(getMugger().isVisiblyPregnant()) {
						pregnancyReaction = true;
						
						if(!getMugger().isCharacterReactedToPregnancy(Main.game.getPlayer())) {
							UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_REPEAT_PREGNANCY_REVEAL", getAllCharacters()));
						
						} else {
							UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_REPEAT_STILL_PREGNANT", getAllCharacters()));
						}
					}
					...
					if(Main.game.getPlayer().isVisiblyPregnant() || getMainCompanion().isVisiblyPregnant()) {
						...
						if((Main.game.getPlayer().isVisiblyPregnant() && !Main.game.getPlayer().isCharacterReactedToPregnancy(getMugger()))
							...
							UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_REPEAT_PLAYER_COMPANION_PREGNANCY", getAllCharacters()));
						
						} else {
							UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_REPEAT_CONTINUED_PLAYER_COMPANION_PREGNANCY", getAllCharacters()));
						}
					}

					if(!pregnancyReaction) {
						UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_REPEAT", getAllCharacters()));
					}
					
					UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_REPEAT_END", getAllCharacters()));

				} else { // The mugger doesn't want to attack the player:
					UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_PEACEFUL_INTRO", getAllCharacters()));
					
					if(getMugger().isVisiblyPregnant()) {
						pregnancyReaction = true;
						
						if(!getMugger().isCharacterReactedToPregnancy(Main.game.getPlayer())) {
							UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_PEACEFUL_PREGNANCY_REVEAL", getAllCharacters()));
						
						} else {
							UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_PEACEFUL_STILL_PREGNANT", getAllCharacters()));
						}
					}
					...
					if(Main.game.getPlayer().isVisiblyPregnant() || getMainCompanion().isVisiblyPregnant()) {
						...
						if((Main.game.getPlayer().isVisiblyPregnant() && !Main.game.getPlayer().isCharacterReactedToPregnancy(getMugger()))
								|| (getMainCompanion().isVisiblyPregnant() && !getMainCompanion().isCharacterReactedToPregnancy(getMugger()))) {
							UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_PEACEFUL_PLAYER_COMPANION_PREGNANCY", getAllCharacters()));
						
						} else {
							UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_PEACEFUL_CONTINUED_PLAYER_COMPANION_PREGNANCY", getAllCharacters()));
						}
					}
					
					if(!pregnancyReaction) {
						UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_PEACEFUL", getAllCharacters()));
					}
					
					UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_PEACEFUL_END", getAllCharacters()));

					UtilText.nodeContentSB.append(getStatus());
				}
				
			} else {
				UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_INTRO", getAllCharacters()));
				
				UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK", getAllCharacters()));
			}
				...
				if (index == 1) {
					...
					if(Main.game.getPlayer().getMoney()<250) {
						...
						return new Response("Offer money ("+UtilText.formatAsMoney(250, "span")+")", "Offer to pay [npc.name] 250 flames to leave you alone.", Main.game.getDefaultDialogueNoEncounter()) {
							...
							public void effects() {
								...
								UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_PAY_OFF", getAllCharacters()));
							}
						};
					}
					...
					if(getMugger().isAttractedTo(Main.game.getPlayer())) {
						return new ResponseSex("Offer body", "Offer your body to [npc.name] so that you can avoid a violent confrontation.",
								...
								AFTER_SEX_DEFEAT,
								UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_ATTACK_OFFER_BODY_SOLO_WITH_COMPANION", getMugger(), getMainCompanion())) {
							@Override
							public void effects() {
								applyPregnancyReactions();
							}
	...
	public static final DialogueNode TUNNEL_PEACEFUL_TALK = new DialogueNode("Talk", "", true, true) {
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_PEACEFUL_TALK", getAllCharacters()));

			UtilText.nodeContentSB.append(getStatus());
			
			if(isAffectionHighEnoughToInviteHome()) {
				if(Main.game.getPlayer().isQuestCompleted(QuestLine.SIDE_ACCOMMODATION)) {
					UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_PEACEFUL_CAN_INVITE_HOME", getAllCharacters()));
				} else {
					UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_PEACEFUL_CAN_INVITE_HOME_REQUIRES_LILAYA_PERMISSION", getAllCharacters()));
				}
			}
	...
	public static final DialogueNode TUNNEL_PEACEFUL_OFFER_MONEY = new DialogueNode("Offer money", "", true, true) {
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_PEACEFUL_OFFER_MONEY", getAllCharacters()));
	...
	public static final DialogueNode TUNNEL_PEACEFUL_OFFER_ROOM = new DialogueNode("Offer room", "", true, true) {
		...
		@Override
		public String getContent() {
			return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_PEACEFUL_OFFER_ROOM", getAllCharacters());
		}
	...
	public static final DialogueNode TUNNEL_PEACEFUL_OFFER_ROOM_BACK_HOME = new DialogueNode("New Room", "", true) {
		...
		@Override
		public String getContent() {
			return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_PEACEFUL_OFFER_ROOM_BACK_HOME", getAllCharacters());
		}
	...
	public static final DialogueNode TUNNEL_PEACEFUL_ATTACK = new DialogueNode("Attack", "", true, true) {
		...
		@Override
		public String getContent() {
			return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "TUNNEL_PEACEFUL_ATTACK", getAllCharacters());
		}
	...
	public static final DialogueNode AFTER_SEX_PEACEFUL = new DialogueNode("Continue", "Step away from [npc.name] and prepare to continue on your way.", true) {
		...
		public String getContent() {
			if(Sex.getNumberOfOrgasms(getMugger())>0) {
				return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_SEX_PEACEFUL", getAllCharacters());
			} else {
				return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_SEX_PEACEFUL_NO_ORGASM", getAllCharacters());
			}
		}
	...
	public static final DialogueNode AFTER_COMBAT_VICTORY = new DialogueNode("Victory", "", true) {
		...
		public String getContent() {
			if((getMugger().isAttractedTo(Main.game.getPlayer()) || !Main.game.isNonConEnabled())
				...
				return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_VICTORY_ATTRACTION", getAllCharacters());
				
			} else {
				return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_VICTORY_NO_ATTRACTION", getAllCharacters());
			}
		}
			...
			if((getMugger().isAttractedTo(Main.game.getPlayer()) || !Main.game.isNonConEnabled())
				...
				if (index == 1) {
					...
					return new Response(
						...
						@Override
						public void effects() {
							Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_VICTORY_BANISH_NPC", getAllCharacters()));
							Main.game.banishNPC(getMugger());
						}
					};
				...
				if (index == 1) {
					...
					return new ResponseSex("Rape [npc.herHim] (gentle)", "[npc.She] needs to be punished for attacking you like that... (Start the sex scene in the 'gentle' pace.)",
							...
							new SMGeneric(
									...
									null,
									ResponseTag.START_PACE_PLAYER_DOM_GENTLE),
							AFTER_SEX_VICTORY, UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_VICTORY_RAPE_GENTLE", getAllCharacters()));
					...
					return new ResponseSex("Rape [npc.herHim] (rough)", "[npc.She] needs to be punished for attacking you like that... (Start the sex scene in the 'rough' pace.)",
							...
							new SMGeneric(
									...
									null,
									null,
									ResponseTag.START_PACE_PLAYER_DOM_ROUGH), AFTER_SEX_VICTORY, UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_VICTORY_RAPE_ROUGH", getAllCharacters()));
	...
	public static final DialogueNode AFTER_COMBAT_VICTORY_TALK = new DialogueNode("Talk", "", true) {
		...
		@Override
		public String getContent() {
			return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_VICTORY_TALK", getAllCharacters());
		}
	...
	public static final DialogueNode AFTER_COMBAT_DEFEAT = new DialogueNode("Defeat", "", true) {
		...
		public String getContent() {
			...
			if(getMugger().hasFlag(NPCFlagValue.genericNPCBetrayedByPlayer)) {
				return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_DEFEAT_BETRAYED", getAllCharacters());
			}
			...
			if(getMugger().isWillingToRape(Main.game.getPlayer())
				...
				if (getMugger().isAttractedTo(Main.game.getPlayer()) && getMugger().isAttractedTo(companion)) {
					return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_DEFEAT_NO_TF_ATTRACTED", getAllCharacters());
				
				} else if (getMugger().isAttractedTo(companion) && Main.getProperties().hasValue(PropertyValue.involuntaryNTR)) {
					return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_DEFEAT_WANTS_COMPANION", getAllCharacters());
...
//				System.out.println(potion.getValue().getName()); 
				...
				if(potion == null) {
					return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_DEFEAT_TF_FINISHED", getAllCharacters());
					
				} else {
					return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_DEFEAT_TF", getAllCharacters());
				}
			}
			...
			if(getMugger().isAttractedTo(Main.game.getPlayer()) && getMugger().isWillingToRape(Main.game.getPlayer())) {
				...
				return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_DEFEAT_NO_TF_NOT_ATTRACTED", getAllCharacters());
			}
		}
...
//							System.out.println(potion); 
				...
				if (index == 1) {
					...
					return new ResponseSex("Eager Sex",
							...
							AFTER_SEX_DEFEAT, UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_DEFEAT_SEX_EAGER", getAllCharacters()));
	...
	public static final DialogueNode AFTER_COMBAT_TRANSFORMATION_REFUSED = new DialogueNode("Avoided Transformation", "", true) {
		...
		public String getContent() {
			if(getMugger().isAttractedTo(Main.game.getPlayer())) {
				return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_TRANSFORMATION_REFUSED_ATTRACTED", getAllCharacters());
			
			} else {
				return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_TRANSFORMATION_REFUSED_NOT_ATTRACTED", getAllCharacters());
			}
		}
	...
	public static final DialogueNode AFTER_COMBAT_TRANSFORMATION = new DialogueNode("Transformed", "", true) {
		...
		public String getContent() {
			if(getMugger().isAttractedTo(Main.game.getPlayer())) {
				return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_TRANSFORMATION_ATTRACTED", getAllCharacters());
			
			} else {
				return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_COMBAT_TRANSFORMATION_NOT_ATTRACTED", getAllCharacters());
			}
		}
		...
		public String getContent() {
			if((getMugger().isAttractedTo(Main.game.getPlayer()) || !Main.game.isNonConEnabled())
				...
				if(Sex.getNumberOfOrgasms(Sex.getActivePartner()) >= 1) {
					return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_SEX_VICTORY", getAllCharacters());
				} else {
					return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_SEX_VICTORY_NO_ORGASM", getAllCharacters());
				}
				
			} else {
				if(getMugger().hasFlag(NPCFlagValue.genericNPCBetrayedByPlayer)) {
					return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_SEX_VICTORY_RAPE_BETRAYED", getAllCharacters());
				} else {
					return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_SEX_VICTORY_RAPE", getAllCharacters());
				}
			}
		}
	...
	public static final DialogueNode AFTER_SEX_DEFEAT = new DialogueNode("Collapse", "", true) {
		...
		@Override
		public String getContent() {
			return UtilText.parseFromXMLFile("encounters/submission/tunnelAttackCompanions", "AFTER_SEX_DEFEAT", getAllCharacters());
		}
