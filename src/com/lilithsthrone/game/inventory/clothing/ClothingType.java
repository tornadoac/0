...
public class ClothingType {
	...
	public static AbstractClothingType HEAD_CHEATERS_CIRCLET = new AbstractClothingType(1000,
			...
			Util.newArrayListOfValues(
					new BlockedParts(
							...
							null, null)),
			null,
			ColorListPresets.JUST_GOLD.getPresetColorList(),
			null,
			null,
			null,
			null,
	...
	public static AbstractClothingType PIERCING_NAVEL_GEM = new AbstractClothingType(400,
			...
			ColorListPresets.ALL_METAL.getPresetColorList(),
			null,
			ColorListPresets.JUST_WHITE.getPresetColorList(),
	...
	public static AbstractClothingType HEAD_COWBOY_HAT = new AbstractClothingType(750,
			...
			Util.newArrayListOfValues(
					new BlockedParts(
							...
							null)),
			null,
			ColorListPresets.LEATHER.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			null,
			null,
			null,
	...
	public static AbstractClothingType HEAD_ANTLER_HEADBAND = new AbstractClothingType(60,
			...
			Util.newArrayListOfValues(new BlockedParts(DisplacementType.REMOVE_OR_EQUIP, Util.newArrayListOfValues(ClothingAccess.HEAD), null, null, null)),
			null,
			ColorListPresets.JUST_BROWN.getPresetColorList(),
			null,
			null,
			null,
			null,
	...
	public static AbstractClothingType EYES_AVIATORS = new AbstractClothingType(1200,
			...
			ColorListPresets.ALL_METAL.getPresetColorList(),
			null,
			ColorListPresets.JUST_ORANGE.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			null,
			null,
			Util.newArrayListOfValues(ItemTag.SOLD_BY_NYAN)){
	...
	public static AbstractClothingType NECK_COLLAR_BOWTIE = new AbstractClothingType(150,
			...
			Util.newArrayListOfValues(new BlockedParts(DisplacementType.REMOVE_OR_EQUIP, null, null, null, null)),
			null,
			ColorListPresets.JUST_BLACK.getPresetColorList(), ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_WHITE.getPresetColorList(), ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_BLACK.getPresetColorList(), ColorListPresets.ALL.getPresetColorList(),
			Util.newArrayListOfValues(ItemTag.SOLD_BY_NYAN)){
	...
	public static AbstractClothingType NECK_BREEDER_COLLAR = new AbstractClothingType(10000,
			...
			Util.newArrayListOfValues(
					...
					new ItemEffect(ItemEffectType.CLOTHING, TFModifier.TF_MOD_FETISH_BEHAVIOR, TFModifier.TF_MOD_FETISH_PREGNANCY, TFPotency.MAJOR_BOOST, 0),
					new ItemEffect(ItemEffectType.CLOTHING, TFModifier.TF_MOD_FETISH_BEHAVIOR, TFModifier.TF_MOD_FETISH_IMPREGNATION, TFPotency.MAJOR_BOOST, 0),
			...
			Util.newArrayListOfValues(new BlockedParts(DisplacementType.REMOVE_OR_EQUIP, null, null, null, null)),
			null,
			ColorListPresets.JUST_PINK.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_STEEL.getPresetColorList(),
			ColorListPresets.ALL_METAL.getPresetColorList(),
			ColorListPresets.JUST_STEEL.getPresetColorList(),
	...
	public static AbstractClothingType TORSO_OVER_HOODIE = new AbstractClothingType(300,
			...
			null,
			ColorListPresets.ALL.getPresetColorList(), null,
			null, null,
			null, null,
			Util.newArrayListOfValues(ItemTag.SOLD_BY_NYAN)){
...
//									InventorySlot.PIERCING_TONGUE,
	...
	public static AbstractClothingType TORSO_OVER_CHRISTMAS_SWEATER = new AbstractClothingType(100,
			...
			null,
			ColorListPresets.NOT_WHITE.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_WHITE.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			null,
	...
	public static AbstractClothingType CHEST_CHEMISE = new AbstractClothingType(250,
			...
			null,
			ColorListPresets.LINGERIE.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			null,
			null,
			null,
	...
	public static AbstractClothingType HIPS_SUSPENDER_BELT = new AbstractClothingType(150,
			...
			Util.newArrayListOfValues(
					new BlockedParts(
							...
							null)),
			null,
			ColorListPresets.LINGERIE.getPresetColorList(), ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_STEEL.getPresetColorList(), ColorListPresets.ALL_METAL.getPresetColorList(),
			null,
			null,
			Util.newArrayListOfValues(ItemTag.SOLD_BY_NYAN)){
	...
	public static AbstractClothingType LEG_TIGHT_TROUSERS = new AbstractClothingType(400,
			...
			Util.newArrayListOfValues(
					...
					new BlockedParts(
							...
							PresetConcealmentLists.CONCEALED_UNZIPS_GROIN.getPresetInventorySlotList())),
			null,
			ColorListPresets.DENIM.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			null,
			null,
			null,
	...
	public static AbstractClothingType FOOT_STILETTO_HEELS = new AbstractClothingType(500,
			...
			ColorListPresets.ALL.getPresetColorList(),
			null,
			ColorListPresets.JUST_TAN.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_GREY.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			Util.newArrayListOfValues(ItemTag.SOLD_BY_NYAN)){
...
//	};
	...
	public static AbstractClothingType MAID_HEADPIECE = new AbstractClothingType(600,
			...
			"Maid's headpiece",
			"Maid's headpieces",
			"A heavily stylized Maid's headpiece, it consists of a colored headband with a decorative white lace attached on top.",
			1,
			Femininity.FEMININE,
			InventorySlot.HEAD,
			Rarity.EPIC,
			...
			Util.newArrayListOfValues(
					new BlockedParts(
							...
							null)),
			null,
			ColorListPresets.MAID.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_WHITE.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			null,
	...
	public static AbstractClothingType MAID_DRESS = new AbstractClothingType(2500, //TODO
			...
			"Maid's dress",
			"Maid's dresses",
			"A heavily stylized Maid's dress, it consists of a colored one-piece dress with decorative white lace trimmings."
	...
	public static AbstractClothingType MAID_STOCKINGS = new AbstractClothingType(450,
			...
			"Maid's stockings",
			"Maid's stockings",
			"A pair of cotton Maid's stockings, with a colored bow near the top.",
			1,
			Femininity.FEMININE,
			InventorySlot.SOCK,
			Rarity.EPIC,
	...
	public static AbstractClothingType MAID_HEELS = new AbstractClothingType(800,
			...
			"Maid's high heels",
			"Maid's high heels",
			"A pair of Maid's high heels, they are made of colored leather with a small amount of white lace decoration.",
			1,
			Femininity.FEMININE,
			InventorySlot.FOOT,
			Rarity.EPIC,
	...
	public static AbstractClothingType MAID_SLEEVES = new AbstractClothingType(350,
			...
			"Maid's sleeves",
			"Maid's sleeves",
			"A pair of Maid's sleeves that end just past the elbow. They are made of soft colored fabric with white lace trimmings.",
			1,
			Femininity.FEMININE,
			InventorySlot.HAND,
			Rarity.EPIC,
...
//		}
		...
		public String equipText(GameCharacter clothingOwner, GameCharacter clothingRemover, boolean rough, AbstractClothing clothing, boolean applyEffects) {
			return getEquipDescriptions(clothingOwner, clothingRemover, rough,
					"You open your mouth wide and slide in the ball gag, before reaching back and fastening the buckles to keep it in place.<br/>"
							+ "[style.colorArcane(The ball gag glows with arcane energy as it reveals its jinx!)]",
	...
	public static AbstractClothingType BDSM_RINGGAG = new AbstractClothingType(200,
			...
			Util.newArrayListOfValues(
					new BlockedParts(
							...
							null, null)),
			null,
			ColorListPresets.ALL_WITH_METALS.getPresetColorList(),
			null,
			ColorListPresets.JUST_BLACK.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_STEEL.getPresetColorList(),
	...
	public static AbstractClothingType CATTLE_PIERCING_EAR_TAGS = new AbstractClothingType(150,
			...
			Util.newArrayListOfValues(
					new BlockedParts(
							...
							null, null, null, null)),
			null,
			ColorListPresets.JUST_YELLOW.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_RED.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			null,
			null,
			Util.newArrayListOfValues(ItemTag.SOLD_BY_FINCH)){
			...
			Util.newArrayListOfValues(
					...
					new BlockedParts(
							...
							Util.newArrayListOfValues(
									...
									InventorySlot.PIERCING_NIPPLE))),
			null,
			ColorListPresets.MILK_MAID.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_WHITE.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			null,
	...
	public static AbstractClothingType SOCK_RAINBOW_STOCKINGS = new AbstractClothingType(250,
			...
			"rainbow stockings",
			"rainbow stockings",
			"A pair of brightly colored rainbow stockings that reach up to mid-thigh.",
			1,
			Femininity.FEMININE,
			InventorySlot.SOCK,
			Rarity.EPIC,
			...
			Util.newArrayListOfValues(
					new BlockedParts(
							...
							null, null, null)),
			null,
			Util.newArrayListOfValues(Color.CLOTHING_MULTICOLORED),
			null,
			null,
			null,
			null,
	...
	public static AbstractClothingType HAND_RAINBOW_FINGERLESS_GLOVES = new AbstractClothingType(250,
			...
			"rainbow glove",
			"rainbow gloves",
			"A pair of brightly-colored rainbow fingerless gloves.",
			1,
			Femininity.FEMININE,
			InventorySlot.HAND,
			Rarity.EPIC,
	...
	public static AbstractClothingType KIMONO_HAIR_KANZASHI = new AbstractClothingType(500,
			...
			null,
			null,
			ColorListPresets.KIMONO.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_WHITE.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.KIMONO.getPresetColorList(),
	...
	public static AbstractClothingType SCIENTIST_TORSO_OVER_LAB_COAT = new AbstractClothingType(800,
			...
			Util.newArrayListOfValues(
					...
					new BlockedParts(
							...
							PresetConcealmentLists.CONCEALED_DRESS_FRONT_FULL.getPresetInventorySlotList())),
			null,
			ColorListPresets.BLACK_OR_WHITE.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			null,
			null,
			null,
	...
	public static AbstractClothingType NECK_SNOWFLAKE_NECKLACE = new AbstractClothingType(250,
			...
			Util.newArrayListOfValues(new BlockedParts(DisplacementType.REMOVE_OR_EQUIP, null, null, null, null)),
			null,
			ColorListPresets.JUST_SILVER.getPresetColorList(),
			ColorListPresets.ALL_METAL.getPresetColorList(),
			null,
			null,
			null,
	...
	public static AbstractClothingType NECK_SUN_NECKLACE = new AbstractClothingType(250,
			...
			Util.newArrayListOfValues(new BlockedParts(DisplacementType.REMOVE_OR_EQUIP, null, null, null, null)),
			null,
			ColorListPresets.JUST_COPPER.getPresetColorList(),
			ColorListPresets.ALL_METAL.getPresetColorList(),
			ColorListPresets.JUST_ORANGE.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			null,
	...
	public static AbstractClothingType AMBERS_BITCH_CHOKER = new AbstractClothingType(1250,
			...
			Util.newArrayListOfValues(
					new ItemEffect(ItemEffectType.CLOTHING, TFModifier.TF_MOD_FETISH_BEHAVIOR, TFModifier.TF_MOD_FETISH_SUBMISSIVE, TFPotency.MAJOR_BOOST, 0),
			...
			Util.newArrayListOfValues(
					new BlockedParts(
							...
							null, null)),
			null,
			Util.newArrayListOfValues(Color.CLOTHING_PINK_LIGHT),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_STEEL.getPresetColorList(),
			ColorListPresets.ALL_METAL.getPresetColorList(),
			null,
	...
	public static AbstractClothingType HEAD_SLIME_QUEENS_TIARA = new AbstractClothingType(10000,
			...
			ColorListPresets.JUST_GOLD.getPresetColorList(),
			ColorListPresets.ALL_METAL.getPresetColorList(),
			ColorListPresets.JUST_DARK_RED.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_GOLD.getPresetColorList(),
			ColorListPresets.ALL_METAL.getPresetColorList(),
			null){
	...
	public static AbstractClothingType FINGER_LYSSIETHS_RING = new AbstractClothingType(50000,
			...
			Util.newArrayListOfValues(
					new BlockedParts(DisplacementType.REMOVE_OR_EQUIP,
							...
							null, null)),
			null,
			ColorListPresets.JUST_ROSE_GOLD.getPresetColorList(),
			ColorListPresets.ALL_METAL.getPresetColorList(),
			ColorListPresets.JUST_DARK_RED.getPresetColorList(),
			ColorListPresets.ALL.getPresetColorList(),
			ColorListPresets.JUST_ROSE_GOLD.getPresetColorList(),
